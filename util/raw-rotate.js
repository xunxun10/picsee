...
//       lightdrift-libraw 默认 user_flip = -1，即沿用相机 EXIF 朝向；LibRaw 在
//       copy_mem_image() 中按 S.flip 调 flip_index() 输出像素，且当 S.flip & 4
//       （90°/270°）时交换宽高 —— 即朝向已由 libraw 烘进像素，这条路径不需要、
//       也不能再额外旋转。（实测：把 CR2 朝向标记改为 6，输出尺寸由 3200x2136
//       变为 3200x4794，印证已自动摆正。）
//
